...
<body>
        ...
        <body>
                ...
                <div class="modal-dialog text-center" style="margin-left: 470px" >
                        <div class="col-sm-8 main-section">
                          <div class="modal-content">
                         
                              <form class="col-12" method="post" action="/guardar">
                                    {{ csrf_field() }}  
...
<div class="custom-control custom-radio" style="margin-left: 150px;">
      ...
      <div class="custom-control custom-radio" style="margin-right: 150px; margin-top: -23px">
            <input type="radio" class="custom-control-input" id="femenino" name="genero" value="femenino" >
            <label class="custom-control-label" for="femenino">femenino</label>
          </div>
                                        </div>
                            
                          <button type="submit" class="btn  " ><i class="fas fa-share-square"></i>registrar</button>
                        </form>
